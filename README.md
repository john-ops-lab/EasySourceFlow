...
[![Version](https://img.shields.io/badge/version-v0.2.0-FF0000)](CHANGELOG.md)
...
处理 YouTube 前，在 Chrome 中登录账号，然后进入“维护 → 账号与授权”导入 YouTube 登录态。导入文件只保留 YouTube 域 Cookie，并写入本机数据目录。
